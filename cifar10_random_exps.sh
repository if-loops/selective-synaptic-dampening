...
reset_cuda
CUDA_VISIBLE_DEVICES=$DEVICE python forget_random_main.py -net ResNet18 -dataset $dataset -classes $n_classes -gpu -method pdr_tuning -forget_perc $forget_perc -weight_path $weight_path -seed $seed
reset_cuda
